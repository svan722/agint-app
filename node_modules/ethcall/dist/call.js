...
import { deploylessMulticall2Bytecode, deploylessMulticall3Bytecode, deploylessMulticallBytecode, } from './multicall.js';
...
async function tryAll(provider, multicall2, calls, overrides) {
    ...
    const response = contract && contract.tryAggregate
...
async function tryEach(provider, multicall3, calls, overrides) {
    ...
    const response = contract && contract.aggregate3
